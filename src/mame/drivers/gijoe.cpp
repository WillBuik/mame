...
void gijoe_state::fr_setup(flow_render::manager *manager)
{
	...
	manager->connect(m_tilemap->flow_render_get_renderer("a")->out(), rm->inp("1 color"));
...
static ADDRESS_MAP_START( gijoe_map, AS_PROGRAM, 16, gijoe_state )
	...
	AM_RANGE(0x1c0000, 0x1c001f) AM_DEVICE8("soundctrl", k054321_device, main_map, 0x00ff)
...
static ADDRESS_MAP_START( sound_map, AS_PROGRAM, 8, gijoe_state )
	...
	AM_RANGE(0xfc00, 0xfc03) AM_DEVICE("soundctrl", k054321_device, sound_map)
...
static MACHINE_CONFIG_START( gijoe )
	...
	MCFG_FLOW_RENDER_MANAGER_SETUP(":", gijoe_state, fr_setup)

	MCFG_SCREEN_ADD("screen", RASTER)
	MCFG_SCREEN_RAW_PARAMS(6000000, 384, 0, 288, 264, 0, 224)
	MCFG_SCREEN_FLOW_RENDER_RGB()

	MCFG_PALETTE_ADD("palette", 2048)
	MCFG_PALETTE_FORMAT(xBBBBBGGGGGRRRRR)

	MCFG_K054156_054157_ADD("tilemap", 6000000, 2, 2, 24)
	...
	MCFG_K054156_054157_KSNOTIFIER_CB(DEVKSNOTIFIER(":sprites", k053246_053247_device, ksnotifier_w))
	MCFG_VIDEO_SET_SCREEN("screen")

	MCFG_K053246_053247_ADD("sprites", 6000000, "spriteram")
