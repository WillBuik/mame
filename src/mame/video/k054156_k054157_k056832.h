...
class k054156_056832_device : public device_t, public device_gfx_interface, public device_video_interface, public flow_render::interface
{
public:
	...
	void ksnotifier_w(int clk, int hbp, int hv, int hfp, int hs, int vbp, int vv, int vfp, int vs);
